...
<body class="account-pages">
                    ...
                    <div class="card-box shadow-none p-4">
                        <div class="p-2">
                            ...
                            <h4 class="font-size-18 mt-5 text-center">Reset Password</h4>
                             ...
                             <div class="alert alert-success mt-4 mb-1" role="alert">
  ...
  event.preventDefault(); // Prevents the form from submitting
   submitform();
            ...
            data.email=$('#resetPasswordForm').find('#email').val();
         
            var url="<?=base_url('admin/forgot/password');?>";
        ...
        response.then(function(data){
         ...
         if(data.status)
         {
          ...
          else if(!data.status && data.errors)
          {
           ...
           $('#resetPasswordForm').find('#'+key).after('<div class="validation-error">'+data.errors[key]+'</div>');
