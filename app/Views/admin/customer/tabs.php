  <ul class="nav nav-tabs" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link <?=$activeTab=='profile'?'active':''?>"  href="<?=base_url('admin/customers/'.$customer->user_id.'/view')?>" role="tab" aria-selected="true">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link <?=$activeTab=='vehicles'?'active':''?>" href="<?=base_url('admin/customers/'.$customer->user_id.'/vehicles/view')?>" role="tab" aria-selected="false" tabindex="-1">
