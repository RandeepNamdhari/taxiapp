<div class="modal fade bs-driver-modal-center" tabindex="-1" aria-labelledby="mySmallModalLabel" aria-modal="true" role="dialog" style="display: none; padding-left: 0px;">
                                                    <div class="modal-dialog modal-dialog-centered ">
                                                        <div class="modal-content border-0">
                                                            <div class="modal-header bg-success p-2 m-0">
                                                                <h5 class="modal-title ">Driver List</h5>
                                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                            </div>
                                                            <div class="modal-body">

                                                                <div class="col-sm-12 border-0">
                                                <input class="form-control border-0" type="text" placeholder="Search with driver name..."  id="searchDriverInList" onkeyup="showDrivers(this,'#driver_list_area')">
                                                <input type="hidden" name="type" id="existingUsersType">
                                                <input type="hidden" name="model_id" id="modelId">
                                            </div>


                                            <div data-simplebar="init" style="max-height: 230px;" class="simplebar-dragging"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: -15px; bottom: 0px;"><div class="simplebar-content-wrapper" style="height: auto; overflow: hidden scroll;"><div class="simplebar-content" id="driver_list_area" style="padding: 0px;pointer-events: all;">
