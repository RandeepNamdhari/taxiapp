...
class VehicleBodyTypeModel extends Model
{
           ...
           public function create($data)
   {
        ...
        return array('status'=>1,'message'=>'The body type is created or updated successfully.','type'=>'success');
    ...
    {
        $stateObj=new \App\Models\VehicleBodyTypeModel();
